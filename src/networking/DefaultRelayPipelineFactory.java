...
public class DefaultRelayPipelineFactory implements ChannelPipelineFactory {
    ...
    public DefaultRelayPipelineFactory(final String hostAndPort, final HttpRequest httpRequest, final RelayListener relayListener, final Channel browserToProxyChannel, final ChannelGroup channelGroup, final HttpResponseFilters responseFilters, final HttpRequestFilter requestFilter) {
    ...
    public ChannelPipeline getPipeline() throws Exception {
            ...
            if (filter == null) {
                ...
                if (shouldFilter) {
                    ...
                    pipeline.addLast("aggregator",
                        new HttpChunkAggregator(filter.getMaxResponseSize()));
                }
            }
        }
        ...
        final ProxyHttpRequestEncoder encoder = new ProxyHttpRequestEncoder(handler, requestFilter);
